                    ...
                    <form action="{{ route('author.blogs.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" name="featured_image" id="featured_image" 
                                class="mt-1 block w-full text-sm text-gray-500 border border-gray-300 rounded-md shadow-sm file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:bg-indigo-50 file:text-indigo-600 hover:file:bg-indigo-100"
                        ...
                        <!-- Image Caption -->
                        <div class="mb-4">
                            <label for="image_caption" class="block text-sm font-medium text-gray-700">Image Caption</label>
